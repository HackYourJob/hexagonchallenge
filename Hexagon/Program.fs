...
let start port wwwDirectory =
    ...
    let aiRestWebPart = aiRest (AisService.submitAi AiStorageInMySql.updateOrAdd) (AisService.getAi AiStorageInMySql.tryToGetCode) (AiStorageInmemory.getMatchEvents)
